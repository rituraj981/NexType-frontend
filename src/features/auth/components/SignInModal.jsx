...
import { X, Mail, Lock, Github, Twitter } from 'lucide-react';

export function SignInModal({ onClose, onSwitchToSignUp }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">Enter your details to access your account.</p>
      </div>
      ...
      <div className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
        ...
        <button onClick={onSwitchToSignUp} className="text-violet-500 hover:text-violet-600 font-semibold transition-colors">
          Sign Up
        </button>
      </div>
    </motion.div>
